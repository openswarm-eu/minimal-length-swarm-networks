...
extern HopCountDefaultTypeInternal _HopCount_default_instance_;
class Orientation;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::HopCount* Arena::CreateMaybeMessage<::HopCount>(Arena*);
...
class HopCount final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:HopCount) */ {
 public:
  inline HopCount() : HopCount(nullptr) {}
  ~HopCount() override;
  explicit PROTOBUF_CONSTEXPR HopCount(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  HopCount(const HopCount& from);
  HopCount(HopCount&& from) noexcept
    : HopCount() {
    *this = ::std::move(from);
  }

  inline HopCount& operator=(const HopCount& from) {
    CopyFrom(from);
    return *this;
  }
  inline HopCount& operator=(HopCount&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const HopCount& default_instance() {
    return *internal_default_instance();
  }
  static inline const HopCount* internal_default_instance() {
    return reinterpret_cast<const HopCount*>(
               &_HopCount_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(HopCount& a, HopCount& b) {
    a.Swap(&b);
  }
  inline void Swap(HopCount* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(HopCount* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  HopCount* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<HopCount>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const HopCount& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const HopCount& from) {
    HopCount::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(HopCount* other);
  ...
  protected:
  explicit HopCount(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  void set_neighbor(ArgT0&& arg0, ArgT... args);
  std::string* mutable_neighbor();
  PROTOBUF_NODISCARD std::string* release_neighbor();
  void set_allocated_neighbor(std::string* neighbor);
  private:
  const std::string& _internal_neighbor() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_neighbor(const std::string& value);
  std::string* _internal_mutable_neighbor();
  public:
  ...
  // @@protoc_insertion_point(class_scope:HopCount)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr neighbor_;
    uint64_t teamid_;
    uint64_t count_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
...
class Robot final :
 ...
 public:
  ...
  enum : int {
    kHopCountFieldNumber = 9,
    kPrevHopsFieldNumber = 11,
    kNameFieldNumber = 1,
    ...
    kHopCountTeamFieldNumber = 10,
    kStateFieldNumber = 3,
  };
  // repeated .HopCount hopCount = 9;
  int hopcount_size() const;
  private:
  int _internal_hopcount_size() const;
  public:
  void clear_hopcount();
  ::HopCount* mutable_hopcount(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::HopCount >*
      mutable_hopcount();
  private:
  const ::HopCount& _internal_hopcount(int index) const;
  ::HopCount* _internal_add_hopcount();
  public:
  const ::HopCount& hopcount(int index) const;
  ::HopCount* add_hopcount();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::HopCount >&
      hopcount() const;

  // repeated .HopCount prevHops = 11;
  int prevhops_size() const;
  private:
  int _internal_prevhops_size() const;
  public:
  void clear_prevhops();
  ::HopCount* mutable_prevhops(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::HopCount >*
      mutable_prevhops();
  private:
  const ::HopCount& _internal_prevhops(int index) const;
  ::HopCount* _internal_add_prevhops();
  public:
  const ::HopCount& prevhops(int index) const;
  ::HopCount* add_prevhops();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::HopCount >&
      prevhops() const;
  ...
  bool has_hopcountteam() const;
  private:
  bool _internal_has_hopcountteam() const;
  public:
  void clear_hopcountteam();
  uint64_t hopcountteam() const;
  void set_hopcountteam(uint64_t value);
  private:
  uint64_t _internal_hopcountteam() const;
  void _internal_set_hopcountteam(uint64_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::HopCount > hopcount_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::HopCount > prevhops_;
...
// uint64 teamID = 1;
inline void HopCount::clear_teamid() {
  _impl_.teamid_ = uint64_t{0u};
}
inline uint64_t HopCount::_internal_teamid() const {
  return _impl_.teamid_;
}
inline uint64_t HopCount::teamid() const {
  // @@protoc_insertion_point(field_get:HopCount.teamID)
  return _internal_teamid();
}
inline void HopCount::_internal_set_teamid(uint64_t value) {
  
  _impl_.teamid_ = value;
}
inline void HopCount::set_teamid(uint64_t value) {
  _internal_set_teamid(value);
  // @@protoc_insertion_point(field_set:HopCount.teamID)
}

// uint64 count = 2;
inline void HopCount::clear_count() {
  _impl_.count_ = uint64_t{0u};
}
inline uint64_t HopCount::_internal_count() const {
  return _impl_.count_;
}
inline uint64_t HopCount::count() const {
  // @@protoc_insertion_point(field_get:HopCount.count)
  return _internal_count();
}
inline void HopCount::_internal_set_count(uint64_t value) {
  
  _impl_.count_ = value;
}
inline void HopCount::set_count(uint64_t value) {
  _internal_set_count(value);
  // @@protoc_insertion_point(field_set:HopCount.count)
}

// string neighbor = 3;
inline void HopCount::clear_neighbor() {
  _impl_.neighbor_.ClearToEmpty();
}
inline const std::string& HopCount::neighbor() const {
  // @@protoc_insertion_point(field_get:HopCount.neighbor)
  return _internal_neighbor();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void HopCount::set_neighbor(ArgT0&& arg0, ArgT... args) {
 
 _impl_.neighbor_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:HopCount.neighbor)
}
inline std::string* HopCount::mutable_neighbor() {
  std::string* _s = _internal_mutable_neighbor();
  // @@protoc_insertion_point(field_mutable:HopCount.neighbor)
  return _s;
}
inline const std::string& HopCount::_internal_neighbor() const {
  return _impl_.neighbor_.Get();
}
inline void HopCount::_internal_set_neighbor(const std::string& value) {
  
  _impl_.neighbor_.Set(value, GetArenaForAllocation());
}
inline std::string* HopCount::_internal_mutable_neighbor() {
  
  return _impl_.neighbor_.Mutable(GetArenaForAllocation());
}
inline std::string* HopCount::release_neighbor() {
  // @@protoc_insertion_point(field_release:HopCount.neighbor)
  return _impl_.neighbor_.Release();
}
inline void HopCount::set_allocated_neighbor(std::string* neighbor) {
  if (neighbor != nullptr) {
    
  } else {
    
  }
  _impl_.neighbor_.SetAllocated(neighbor, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.neighbor_.IsDefault()) {
    _impl_.neighbor_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:HopCount.neighbor)
}
...
// repeated .HopCount hopCount = 9;
inline int Robot::_internal_hopcount_size() const {
  return _impl_.hopcount_.size();
}
inline int Robot::hopcount_size() const {
  return _internal_hopcount_size();
}
inline void Robot::clear_hopcount() {
  _impl_.hopcount_.Clear();
}
inline ::HopCount* Robot::mutable_hopcount(int index) {
  // @@protoc_insertion_point(field_mutable:Robot.hopCount)
  return _impl_.hopcount_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::HopCount >*
Robot::mutable_hopcount() {
  // @@protoc_insertion_point(field_mutable_list:Robot.hopCount)
  return &_impl_.hopcount_;
}
inline const ::HopCount& Robot::_internal_hopcount(int index) const {
  return _impl_.hopcount_.Get(index);
}
inline const ::HopCount& Robot::hopcount(int index) const {
  // @@protoc_insertion_point(field_get:Robot.hopCount)
  return _internal_hopcount(index);
}
inline ::HopCount* Robot::_internal_add_hopcount() {
  return _impl_.hopcount_.Add();
}
inline ::HopCount* Robot::add_hopcount() {
  ::HopCount* _add = _internal_add_hopcount();
  // @@protoc_insertion_point(field_add:Robot.hopCount)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::HopCount >&
Robot::hopcount() const {
  // @@protoc_insertion_point(field_list:Robot.hopCount)
  return _impl_.hopcount_;
}

// optional uint64 hopCountTeam = 10;
inline bool Robot::_internal_has_hopcountteam() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool Robot::has_hopcountteam() const {
  return _internal_has_hopcountteam();
}
inline void Robot::clear_hopcountteam() {
  _impl_.hopcountteam_ = uint64_t{0u};
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline uint64_t Robot::_internal_hopcountteam() const {
  return _impl_.hopcountteam_;
}
inline uint64_t Robot::hopcountteam() const {
  // @@protoc_insertion_point(field_get:Robot.hopCountTeam)
  return _internal_hopcountteam();
}
inline void Robot::_internal_set_hopcountteam(uint64_t value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.hopcountteam_ = value;
}
inline void Robot::set_hopcountteam(uint64_t value) {
  _internal_set_hopcountteam(value);
  // @@protoc_insertion_point(field_set:Robot.hopCountTeam)
}

// repeated .HopCount prevHops = 11;
inline int Robot::_internal_prevhops_size() const {
  return _impl_.prevhops_.size();
}
inline int Robot::prevhops_size() const {
  return _internal_prevhops_size();
}
inline void Robot::clear_prevhops() {
  _impl_.prevhops_.Clear();
}
inline ::HopCount* Robot::mutable_prevhops(int index) {
  // @@protoc_insertion_point(field_mutable:Robot.prevHops)
  return _impl_.prevhops_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::HopCount >*
Robot::mutable_prevhops() {
  // @@protoc_insertion_point(field_mutable_list:Robot.prevHops)
  return &_impl_.prevhops_;
}
inline const ::HopCount& Robot::_internal_prevhops(int index) const {
  return _impl_.prevhops_.Get(index);
}
inline const ::HopCount& Robot::prevhops(int index) const {
  // @@protoc_insertion_point(field_get:Robot.prevHops)
  return _internal_prevhops(index);
}
inline ::HopCount* Robot::_internal_add_prevhops() {
  return _impl_.prevhops_.Add();
}
inline ::HopCount* Robot::add_prevhops() {
  ::HopCount* _add = _internal_add_prevhops();
  // @@protoc_insertion_point(field_add:Robot.prevHops)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::HopCount >&
Robot::prevhops() const {
  // @@protoc_insertion_point(field_list:Robot.prevHops)
  return _impl_.prevhops_;
}
